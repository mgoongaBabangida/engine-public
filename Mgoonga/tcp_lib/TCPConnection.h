...
namespace dbb
{
	...
	public:
		...
		mutable base::Event<std::function<void(const std::string& _content, const std::string& _endpoint)>>						StringMessageRecieved;
		mutable base::Event<std::function<void(const std::vector<uint32_t>& _content, const std::string& _endpoint)>>	IntArrayMessageRecieved;
