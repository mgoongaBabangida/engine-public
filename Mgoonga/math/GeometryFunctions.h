...
namespace dbb
{
  ...
  DLL_MATH bool IsPointInAABB(const dbb::point& point, const AABB& aabb);
  dbb::point GetClosestPointOnAABB(const AABB& aabb, const dbb::point& point);
  DLL_MATH bool IsPointInOBB(const dbb::point& point, const OBB& obb);
  ...
  CollisionManifold TriangleSphere(const dbb::triangle& t, const dbb::sphere& s);
  bool TriangleAABB(const dbb::triangle& t, const AABB& a);
  DLL_MATH CollisionManifold TriangleOBB(const dbb::triangle& t, const OBB& o);
  ...
  DLL_MATH CollisionManifold FindCollision(const I3DMesh& mesh, const ITransform&, const OBB& B);
  DLL_MATH CollisionManifold FindCollision(const I3DMesh& mesh, const dbb::sphere& B);
  DLL_MATH CollisionManifold FindCollision(const I3DMesh& mesh, const dbb::ellipse& B);
}