...
void DynamicBoundingBoxColliderSerializerYAML::Serialize(BoxColliderDynamic* _box, const std::string& _filepath)
{
  ...
  out << YAML::Key << "Center" << YAML::Value << _box->BaseCollider::GetCenterLocalSpace();
  out << YAML::Key << "Radius" << YAML::Value << _box->BaseCollider::GetRadius();
  out << YAML::Key << "MaxX" << YAML::Value << _box->BaseCollider::GetExtremDotsLocalSpace().MaxX;
  out << YAML::Key << "MaxY" << YAML::Value << _box->BaseCollider::GetExtremDotsLocalSpace().MaxY;
  out << YAML::Key << "MaxZ" << YAML::Value << _box->BaseCollider::GetExtremDotsLocalSpace().MaxZ;
  out << YAML::Key << "MinX" << YAML::Value << _box->BaseCollider::GetExtremDotsLocalSpace().MinX;
  out << YAML::Key << "MinY" << YAML::Value << _box->BaseCollider::GetExtremDotsLocalSpace().MinY;
  out << YAML::Key << "MinZ" << YAML::Value << _box->BaseCollider::GetExtremDotsLocalSpace().MinZ;
