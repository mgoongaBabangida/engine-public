...
void PhysicsEngineTestScript::Update(float _tick)
{
...

  {
    ...
    std::vector<dbb::point> modified = c1.GetVertices();
    dbb::Unite(modified, grass_obb.GetVertices());
    m_normal_mesh->UpdateData(modified,
      { 6,1, 6,3, 6,4, 2,7, 2,5, 2,0, 0,1, 0,3, 7,1, 7,4, 4,5, 5, 3,
        6+8, 1 + 8, 6 + 8,3 + 8, 6 + 8,4 + 8, 2 + 8,7 + 8, 2 + 8,5 + 8, 2 + 8,0 + 8,
        0 + 8,1 + 8, 0 + 8,3 + 8, 7 + 8,1 + 8, 7 + 8,4 + 8, 4 + 8,5 + 8, 5 + 8,3 + 8 },
      { 1.0f, 1.0f ,0.0f, 1.0f });
...
void PhysicsEngineTestScript::Initialize()
{
  ...
  // sphere 1
  {
    ...
    ICollider* c_sph1 = dbb::SphereCollider::CreateFrom(dynamic_cast<BaseCollider&>(*sphere1->GetCollider()), *sphere1->GetTransform());
  ...
  //cube 1
  {
    ...
    ICollider* c_obb1 = dbb::OBBCollider::CreateFrom(dynamic_cast<BaseCollider&>(*cube1->GetCollider()), *cube1->GetTransform());
  ...
  //sphere 2
  {
    ...
    ICollider* c_sph2 = dbb::SphereCollider::CreateFrom(dynamic_cast<BaseCollider&>(*sphere2->GetCollider()), *sphere2->GetTransform());
    sphere2->SetCollider(c_sph2);
  }
  ...
  //cube 2
  {
    ...
    ICollider* c_obb2 = dbb::OBBCollider::CreateFrom(dynamic_cast<BaseCollider&>(*cube2->GetCollider()), *cube2->GetTransform());
  ...
  // plane
  {
    ...
    ICollider* c_grass = dbb::OBBCollider::CreateFrom(dynamic_cast<BaseCollider&>(*grassPlane->GetCollider()), *grassPlane->GetTransform());
