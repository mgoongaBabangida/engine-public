...
public:
	...
	static ShapeData makeTeapot(uint tesselation = 10, const glm::mat4& lidTransform = UNIT_MATRIX);
	...
	static ShapeData makeCapsule(float radius = 0.5f, float height = 2.0f, int slices = 32, int stacks = 16);
};
