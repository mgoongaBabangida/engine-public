...
public:
  ...
  void DispatchForwardPlus(const Camera& _camera, const std::vector<Light>&);
...
protected:
  ...
  GLuint mLightBuffer = Texture::GetDefaultTextureId();
  GLuint mVisibleLightIndicesBuffer = Texture::GetDefaultTextureId();
  unsigned int mWorkGroupsX = 0;
  unsigned int mWorkGroupsY = 0;
