...
private:
	...
	eVolumetricRender* VolumetricRender();
	eLeafRender* LeafRender();
	eDecalRender* DecalRender();
...
private:
	...
	std::unique_ptr <eLeafRender>									m_leafRender;
	std::unique_ptr <eDecalRender>								m_decalRender;
