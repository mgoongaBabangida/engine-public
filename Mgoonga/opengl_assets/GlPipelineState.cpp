...
//------------------------------------------------
void eGlPipelineState::SetBlendFunctionDefault()
{
  glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
}

//-----------------------------------------------
void eGlPipelineState::SetBlendFunctionEditive()
{
  glBlendFunc(GL_SRC_ALPHA, GL_ONE);
}

//----------------------------------------------------
void eGlPipelineState::SetBlendFunctionEditiveBloom()
{
...
//-------------------------------------------
void eGlPipelineState::EnableDebugging()
{
  glEnable(GL_DEBUG_OUTPUT);
  m_debugging_enabled = true;
}
//---------------------------------------------
void eGlPipelineState::DisableDebugging()
{
  glDisable(GL_DEBUG_OUTPUT);
  m_debugging_enabled = false;
}
//-----------------------------------------------
bool eGlPipelineState::IsBlendDebugging() const
{
  return m_debugging_enabled;
}
